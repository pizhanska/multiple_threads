...
public class FileWriter {
    private static  String input[] = {"2","3", "4", "5", "6","1","0"};
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Thread t1 = new Thread(new MyThread(concurrentLinkedQueue, input));
            Thread t2 = new Thread(new MyThread(concurrentLinkedQueue,input));
            t1.start();
            t2.start();
            try {
                t1.join();
